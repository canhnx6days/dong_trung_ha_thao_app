...
// var oCcy  = new NumberFormat("#,##0.00", "vi_VN");
    ...
    return InkWell(
      ...
      child: Stack(
        children: <Widget>[
                  ...
                  children: <Widget>[
                    ...
                    Align(
                      ...
                      child: Container(
                        ...
                        child: Text(
                          // '\$${product.price ?? 0.0}',
                          // '\đ ${product.price.toStringAsFixed(0) ?? 0.0}',
                          '\đ ${oCcy.format(product.price) ?? 0.0}',
                          style: TextStyle(
                              color: Colors.white,
                              // fontSize: 18,
                              fontSize: 18,
          ...
          Positioned(
            child: Hero(
              tag: product.image+'product_list',
              // tag: null,
