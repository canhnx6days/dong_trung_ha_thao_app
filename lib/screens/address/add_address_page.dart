...
class AddAddressPage extends StatelessWidget {
              ...
              children: <Widget>[
                Row(
                  ...
                  children: <Widget>[
                    ...
                    _cardWidget('assets/icons/address_home.png', 'Simon Philip,\nCity Oscarlad'),
                    _cardWidget('assets/icons/address_work.png', 'Workplace'),
                  ],
                ),
                AddAddressForm(),
  ...
  Widget _cardWidget(String imagePath, String text) {
    return Card(
        margin: EdgeInsets.symmetric(vertical: 8.0),
        color: yellow,
        elevation: 3,
  ...
  Widget _finishButton(BuildContext context) => InkWell(
