...
class ProductDisplayAddingCart extends StatelessWidget {
  final Product product;

  const ProductDisplayAddingCart({Key key, this.product}) : super(key: key);
  @override
            ...
            child: Container(
                ...
                child: Align(
                  ...
                  child: RichText(
                    ...
                    TextSpan(
                        // text: '\$ ${product.price}',
                        text: '\đ ${oCcy.format(product.price) ?? 0.0}',
              ...
              child: Stack(
                children: <Widget>[
                  Padding(
                    ...
                    child: Container(
                      child: Hero(
                        tag: product.image+'product_display',
                        // tag: null,
